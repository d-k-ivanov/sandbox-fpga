...
Use only the necessary pragmas to try and reduce the latency of the code from exercise 2 by a factor of 2 (in practice, it will be slightly less). Describe which results indicate that this parallelization has indeed been performed.
